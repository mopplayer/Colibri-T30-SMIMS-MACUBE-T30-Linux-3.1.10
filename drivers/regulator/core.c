...
//	pr_warn("%s _regulator_get(), board_wants_dummy_regulator = %d\n", devname, board_wants_dummy_regulator);//2013.12.11 SMIMS ikki add this
...
//	pr_warn("%s _regulator_get(), has_full_constraints = %d\n", devname, has_full_constraints);//2013.12.11 SMIMS ikki add this
...
//====================================================
//2013.12.11 SMIMS ikki add this, not working
//
